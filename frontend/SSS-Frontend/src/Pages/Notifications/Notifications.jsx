...
const res = await axiosClient.get(
  ...
  const deadlineNotifications = tasks.filter(
    (t) =>
      t.dueDate === today &&
      t.status !== "COMPLETED"
  );
  ...
  const pendingNotifications = tasks.filter(
    (t) =>
      t.status === "PENDING" ||
  ...
  return (
    ...
    <Layout title="Notifications">
      ...
      <div
        className="director-dashboard-page"
        style={{ padding: 0 }}
      >
